...
module.exports = function(app) {
  ...
  app.get('/fail', function(req,res){
    ...
    throw('This is a test 500 error, NODE_ENV='+process.env.NODE_ENV+'!')
  });
  ...
  if ((app.get('env')) === "production") {
    ...
    if (sentry_url) {
      ...
      app.use(raven.middleware.express.requestHandler(sentry_url));

      // The error handler must be before any other error middleware
      app.use(raven.middleware.express.errorHandler(sentry_url));
