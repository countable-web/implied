...
(function() {
  ...
  module.exports = function(app, opts) {
    var Users, db, flash, goto_next, mailer, salt, server_path, statics, _ref;
      ...
      if (req.body.email && req.body.password) {
        ...
        return Users.find({
          ...
          if (users.length === 0) {
            ...
            if (mailer && opts.signup) {
              return typeof mailer === "function" ? mailer({
                to: req.body.email,
                subject: opts.subject || "Welcome!",
                body: opts.body || ("Thankyou for signing up at " + server_path(req))
              }) : void 0;
            }
          } else {
