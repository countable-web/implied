...
module.exports = function(app) {
    var FORMS, NUM_PREVIEWS, PAGE_SIZE, db, photos, process_save, staff, upload_dir;
    ...
    app.get("/blog", function(req, res) {
        ...
        if (req.query.category) {
             ...
             */
            children = _.where(app.locals.TAGS, {
    ...
    app.get("/admin/blog/send/:id", staff, function(req, res) {
        var mailer;
        ...
        return db.collection('blog').findOne({
            ...
            return db.collection("subscribers").find({}).toArray(function(err, entries) {
                var i, len, subscriber;
                for (i = 0, len = entries.length; i < len; i++) {
                    subscriber = entries[i];
    ...
    process_save = function(req, callback) {
        var convert_task_arr, entry, filePath, i, idx, img, len, obj_id, pos, ref, save_img, save_task_arr;
        ...
        convert_task_arr = [];
        idx = 1;
        ref = ["image", "image2", "image3", "image4", "image5", "image6"];
