    ...
    if (process.env.NODE_ENV === "production") {
        ...
        if (sentry_url) {
            ...
            function onError(err, req, res, next) {
                ...
                res.statusCode = 500;
                res.end('<h1>Curses, it seems that ' + (app.get('host') || 'this site') + ' has broke.</h1><p>Your error reference number is ' + res.sentry + '</p>');
            }
            ...
            app.use(function(err, req, res, next) {
                ...
                message += "\nStack Trace:\n============\n\n\n###\n" + err.stack + "\n###\nRequest:\n========\n\n\n\n###\n" + req.method + " " + (req.protocol.toUpperCase()) + "/" + req.httpVersionMajor +
