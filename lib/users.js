...
(function() {
  ...
  me = module.exports = function(app, opts) {
    var Users, build_lookup_query, db, flash, goto_error, goto_then, login, login_success, login_url, logout, mailer, salt, server_path, signup, _ref;
  ...
  me.sanitize = function(s, field_name) {
    var error;
    if (field_name.substr(field_name.length - 3) === "_id") {
      try {
        return util.oid(s);
      } catch (_error) {
        error = _error;
